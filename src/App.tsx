...
const GOOGLE_CLIENT_ID = import.meta.env.VITE_GOOGLE_CLIENT_ID || "940116862121-0hu5vb03bl0eecshf94bl28rm8oek5b2.apps.googleusercontent.com";
...
export default function App() {
  ...
  // Handle Google Redirect Login Callback (Implicit Flow for iOS/Safari/PWA)
  useEffect(() => {
    ...
    if (hash && hash.includes('access_token=')) {
      ...
      if (accessToken && state === 'redirect_login') {
        setLoading(true);
      ...
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 selection:bg-[#FFD700] selection:text-black">
        <div className="w-full max-w-sm flex flex-col items-center">
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-3xl w-full text-center space-y-6">
            ...
            <div className="flex flex-col gap-4 items-center pt-2 w-full">
              ...
              <div className="relative flex py-2 items-center w-full">
                ...
                <span className="flex-shrink mx-4 text-zinc-600 text-xs uppercase tracking-wider font-semibold">ou</span>
                <div className="flex-grow border-t border-zinc-800"></div>
              </div>
              ...
              >
                ...
                <span>Entrar no iPhone / Safari</span>
              </button>
